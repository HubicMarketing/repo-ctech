...
<?php if(is_front_page()) {
		if(!my_wp_is_mobile()) { echo do_shortcode('[rev_slider alias="slider_home"]'); }
						...
						<div class="entry-header-inner section-inner medium">
							...
							if(is_front_page()){ ?>
								<div class="company_info">
								  <p><?php bloginfo('description'); ?></p>
									<?php	include( get_stylesheet_directory() . '/include/cta.php'); ?>
								</div><!--company_info-->
							<?php }
							...
							if ( is_page() ) {
								...
								<div class="to-the-content-wrapper">
									...
									<a href="#form" class="to-the-content fill-children-current-color">
...
<?php //if(is_front_page()) { include( get_stylesheet_directory() . '/include/home/punti_di_forza.php'); } ?>
